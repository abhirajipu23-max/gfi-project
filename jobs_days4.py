...
def get_filtered_ats_stats():
    ...
    filtered_results = ats_counts[
        (ats_counts['job_count'] > 5) & (ats_counts['job_count'] < 15)
...
if __name__ == "__main__":
    ...
    if not stats_df.empty:
        print("\n--- Mid Volume ATS Sites (>5 and <15 jobs) ---")
        print(stats_df)

        filtered_urls = stats_df['ats_url'].tolist()
        ...
        print("\nNo sites found in the 5-15 job count range.")
